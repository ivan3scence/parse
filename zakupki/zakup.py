...
a = date(2021, 10, 1)        # Начало периода
b = date(2021, 10, 9)       # конец периода
id_region = '5277386'       # id региона
thr = 1                    # кол-во потоков
